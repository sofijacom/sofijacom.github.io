...
if (systemInitiatedDark.matches) {
    document.getElementById("theme-toggle").innerHTML = '<i class="fa-solid fa-toggle-on"></i>';
} else {
    document.getElementById("theme-toggle").innerHTML = '<i class="fa-solid fa-toggle-off"></i>';
}
